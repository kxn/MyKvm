# M1 performance collection script (PowerShell, PS5-compatible).
#
...
if (-not (Test-Path -LiteralPath $example)) {
    Write-Error "Release example not found: $example. Run first: cargo build -p ipkvm-desktop-iced --example video_1080p --release"
}
...
$logDir = Join-Path $repoRoot "crates/ipkvm-desktop-iced"
