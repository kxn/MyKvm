...
当前工程已完成工作区脚手架、CH9329 协议编解码和键鼠输入状态核心，以及传输无关的 RFB 3.8 纯协议核心。真实串口传输、设备探测、视频采集、桌面界面、RFB TCP/WebSocket 传输和 noVNC 接入仍按阶段计划继续实现。
...
- `ipkvm-rfb`：RFB 3.8 None 握手、客户端消息增量解码、true-color 像素转换、Raw 更新和 DesktopSize；后续接入 TCP 和 WebSocket 传输。
